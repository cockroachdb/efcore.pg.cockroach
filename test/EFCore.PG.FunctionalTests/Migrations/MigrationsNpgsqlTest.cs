...
""");
    ...
    public override async Task Create_schema()
    {
        ...
        AssertSql(@"CREATE SCHEMA IF NOT EXISTS ""SomeOtherSchema"";",
            //
            """
...
END $EF$;",
    ...
    public virtual async Task Create_enum_with_schema()
    {
        ...
        AssertSql(@"CREATE SCHEMA IF NOT EXISTS some_schema;",
            //
    ...
    public class MigrationsNpgsqlFixture : MigrationsFixtureBase
    {
        ...
        protected override IServiceCollection AddServices(IServiceCollection serviceCollection)
            => base.AddServices(serviceCollection)
                .AddScoped<IDatabaseModelFactory, CockroachDatabaseModelFactory>();
