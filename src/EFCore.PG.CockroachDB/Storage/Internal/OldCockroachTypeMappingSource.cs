...
/// 
/// </summary>
public class OldCockroachTypeMappingSource : RelationalTypeMappingSource
{
#if DEBUG
    ...
    static OldCockroachTypeMappingSource()
    {
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public OldCockroachTypeMappingSource(
