...
/// 
/// </summary>
public class CockroachMigrationsSqlGenerator : MigrationsSqlGenerator
{
    ...
    /// <summary>
    ///     Creates a new <see cref="CockroachMigrationsSqlGenerator" /> instance.
    /// </summary>
...
#pragma warning restore CS0618
    ...
    public virtual void Generate(NpgsqlDropDatabaseOperation operation, IModel? model, MigrationCommandListBuilder builder)
    {
        ...
        // Cockroach doesn't support pg_terminate_backend() function
        builder
...
#pragma warning restore CS0618
        ...
        MigrationCommandListBuilder builder)
    {
        ...
        builder
            ...
            .Append($"({operation.ComputedColumnSql})::{columnType}")
            .Append(") STORED");
